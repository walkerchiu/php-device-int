...
class DeviceRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Device::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(Device::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Device::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Device::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
